        ...
        try {
            for (const item of selectedItems) {
                ...
                finalItems.push({
                    ...
                    discountAmount,
                    validDiscounts,
                    ShopId: productSku.Product.ShopId || productSku.shopId || null,
                    productName: productSku.Product.name || productSku.name || "",
                    categoryId: productSku.Product.CategoryId || productSku.CategoryId || null
                });
            }
            // Payment Intent
